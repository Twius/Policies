...
One consequence is worth being clear about: **if you lose your device, reset it, or uninstall the app, your Cakebyte data is gone for good.** We cannot recover it, because we never had it.
...
The firewall itself is free. The detailed connection log, per-app statistics and alerts are part of a paid unlock called **Cakebyte Pro**. You get a free 14-day trial first. After that it is a single one-time purchase, not a subscription, and it does not renew.
...
Cakebyte includes open-source software written by other people. Mainly that is Google's AndroidX, Material Components and Play Billing libraries under the Apache License 2.0, plus the StevenBlack/hosts blocklist under the MIT License. Their own licences still govern them, and nothing in these Terms takes away a right those licences give you.
