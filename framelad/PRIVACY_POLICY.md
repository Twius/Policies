...
One further note, for completeness. The app's About section contains outward links: to this policy, to the framelad guide, and to the app's Play Store listing. Tapping one hands the web address to whichever browser or store app you have installed, which then loads the page as it would any other. framelad itself opens no connection and includes nothing about you. Aside from a link you tap yourself, if you never use link play the app makes no network connections of any kind.
